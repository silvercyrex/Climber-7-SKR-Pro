...
#define DUAL_X_CARRIAGE
  ...
  #define X1_MAX_POS (X_BED_SIZE - 15)   // A max coordinate so the X1 carriage can't hit the parked X2 carriage
  #define X2_MIN_POS   6          // A min coordinate so the X2 carriage can't hit the parked X1 carriage
  #define X2_MAX_POS   264.54     // The max position of the X2 carriage, typically also the home position
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  40, 40 }, { 160,  40 }, { 180, 160 }, { 40, 160 } }
